...
date: 2019-03-20
permalink: /posts/2019/03/implementing-autoencoder-in-tf2/
tags:
  - Python
  - Machine Learning
  - Deep Learning
...
The encoder (Eq. 1) learns the data representation $z$ from the input features $x$, then the said representation serves as the input to the decoder (Eq. 2) in order to reconstruct the original data $x$. We shall further dissect this model below.
