function updateNav() {
  var e = $btn.hasClass("hidden")
    ? $nav.width()
    : $nav.width() - $btn.width() - 30;
  $vlinks.width() > e
    ? (breaks.push($vlinks.width()),
      $vlinks.children().last().prependTo($hlinks),
      $btn.hasClass("hidden") && $btn.removeClass("hidden"))
    : (e > breaks[breaks.length - 1] &&
        ($hlinks.children().first().appendTo($vlinks), breaks.pop()),
      breaks.length < 1 &&
        ($btn.addClass("hidden"), $hlinks.addClass("hidden"))),
...
!(function (e, t) {
    ...
    if (De(e)) {
      ...
      if (
        ...
        return (
          ...
          "string" == typeof t
            ? ((r = o[t]), null == r && (r = o[pe.camelCase(t)]))
            : (r = o),
          r
        );
    }
      ...
      if (a[s]) {
        if (t && (i = n ? a[s] : a[s].data)) {
          pe.isArray(t)
            ...
            : t in i
            ? (t = [t])
            : ((t = pe.camelCase(t)), (t = t in i ? [t] : t.split(" "))),
            (r = t.length);
          for (; r--; ) delete i[t[r]];
        ...
        if ("object" === pe.type(a)) pe.merge(y, a.nodeType ? [a] : a);
          ...
          if (
            (!de.leadingWhitespace &&
              Re.test(a) &&
              y.push(t.createTextNode(Re.exec(a)[0])),
            !de.tbody)
          )
            for (
              a =
  ...
  function N(e, t, n, i) {
    ...
    if (m || (d > 1 && "string" == typeof p && !de.checkClone && it.test(p)))
      return e.each(function (r) {
        var o = e.eq(r);
        m && (t[0] = p.call(this, r, o.html())), N(o, t, n, i);
      });
    if (
      d &&
      ((u = v(t, e[0].ownerDocument, !1, e, i)),
      (r = u.firstChild),
      1 === u.childNodes.length && (u = r),
      r || i)
    ) {
      for (s = pe.map(h(u, "script"), T), a = s.length; d > c; c++)
        (o = u),
          c !== f &&
            ((o = pe.clone(o, !0, !0)), a && pe.merge(s, h(o, "script"))),
          n.call(e[c], o, c);
      if (a)
        for (l = s[s.length - 1].ownerDocument, pe.map(s, k), c = 0; a > c; c++)
          (o = s[c]),
            ze.test(o.type || "") &&
  ...
  function L(e, t, n) {
    for (var i, r = t ? pe.filter(t, e) : e, o = 0; null != (i = r[o]); o++)
      n || 1 !== i.nodeType || pe.cleanData(h(i)),
        i.parentNode &&
          (n && pe.contains(i.ownerDocument, i) && m(h(i, "script")),
  ...
  function j(e) {
    ...
    return (
      n ||
        ...
        ("none" !== n && n) ||
          ((lt = (
            lt || pe("<iframe frameborder='0' width='0' height='0'/>")
        ...
        i.style &&
          ...
          t
            ? (o[a] || "none" !== n || (i.style.display = ""),
              "" === i.style.display &&
                Be(i) &&
                (o[a] = pe._data(i, "olddisplay", j(i.nodeName))))
            : ((r = Be(i)),
              ((n && "none" !== n) || !r) &&
  ...
  function O(e, t, n, i, r) {
    for (
      ...
      "margin" === n && (a += pe.css(e, n + Pe[o], !0, r)),
        i
          ? ("content" === n && (a -= pe.css(e, "padding" + Pe[o], !0, r)),
            "margin" !== n &&
              (a -= pe.css(e, "border" + Pe[o] + "Width", !0, r)))
          : ((a += pe.css(e, "padding" + Pe[o], !0, r)),
            "padding" !== n &&
              (a += pe.css(e, "border" + Pe[o] + "Width", !0, r)));
    return a;
  }
      ...
      if ((i = R.prefilters[o].call(u, e, c, u.opts)))
        return (
          pe.isFunction(i.stop) &&
            (pe._queueHooks(u.elem, u.opts.queue).stop = pe.proxy(i.stop, i)),
          i
        );
    return (
      pe.map(c, q, u),
  ...
  var ye = (function (e) {
    function t(e, t, n, i) {
      ...
      if (
        !i &&
        ((t ? t.ownerDocument || t : q) !== D && _(t), (t = t || D), H)
      ) {
        if (11 !== m && (u = ve.exec(e)))
          if ((r = u[1])) {
            if (9 === m) {
      ...
      var r = n.length > 0,
        ...
        a = function (i, a, s, l, u) {
          ...
          for (
            ...
            if (o && c) {
              for (
                d = 0, a || c.ownerDocument === D || (_(c), (s = !H));
                (f = e[d++]);
    ...
    (w = t.support = {}),
        ...
        return i !== D && 9 === i.nodeType && i.documentElement
          ? ((D = i),
            ...
            (C.find.CLASS =
              w.getElementsByClassName &&
              function (e, t) {
                return "undefined" != typeof t.getElementsByClassName && H
                  ...
                  return n
                    ...
                    : ((n =
                      ...
                      (!w.sortDetached && t.compareDocumentPosition(e) === n)
                        ? e === D || (e.ownerDocument === q && B(q, e))
                          ? -1
                          : t === D || (t.ownerDocument === q && B(q, t))
                          ? 1
                          : A
                          ? ee(A, e) - ee(A, t)
                          : 0
      ...
      (t.contains = function (e, t) {
        return (e.ownerDocument || e) !== D && _(e), B(e, t);
      }),
      (t.attr = function (e, t) {
        (e.ownerDocument || e) !== D && _(e);
      ...
      (N = t.select = function (e, t, n, i) {
        ...
        if (((n = n || []), 1 === d.length)) {
          if (
            ...
            if (
              ((t = (C.find.ID(a.matches[0].replace(xe, we), t) || [])[0]), !t)
            )
              return n;
  ...
  (pe.filter = function (e, t, n) {
    ...
    pe.fn.extend({
      find: function (e) {
        ...
        return (
          (n = this.pushStack(r > 1 ? pe.unique(n) : n)),
  ...
  pe.extend({
    ...
    hasData: function (e) {
      return (
        (e = e.nodeType ? pe.cache[e[pe.expando]] : e[pe.expando]), !!e && !u(e)
      );
    },
    data: function (e, t, n) {
      return c(e, t, n);
    ...
    pe.fn.extend({
      data: function (e, t) {
        ...
        if (void 0 === e) {
          if (
            this.length &&
            ((r = pe.data(o)), 1 === o.nodeType && !pe._data(o, "parsedAttrs"))
          ) {
            for (n = a.length; n--; )
              a[n] &&
                ((i = a[n].name),
                0 === i.indexOf("data-") &&
                  ((i = pe.camelCase(i.slice(5))), l(o, i, r[i])));
  ...
  !(function () {
    ...
    for (t in { submit: !0, change: !0, focusin: !0 })
      (n = "on" + t),
        (de[t] = n in e) ||
          (i.setAttribute(n, "t"), (de[t] = i.attributes[n].expando === !1));
    i = null;
  })();
      ...
      (pe.event.special.submit = {
        setup: function () {
          return (
            ...
            void pe.event.add(this, "click._submit keypress._submit", function (
              e
            ) {
              var t = e.target,
                n =
  ...
  pe.extend({
    ...
    clone: function (e, t, n) {
      ...
      if (
        ...
        for (i = h(o), s = h(e), a = 0; null != (r = s[a]); ++a)
          i[a] && S(r, i[a]);
      if (t)
        if (n)
          for (s = s || h(e), i = i || h(o), a = 0; null != (r = s[a]); a++)
            E(r, i[a]);
        else E(e, o);
      return (
        (i = h(o, "script")),
        ...
        return Fe(
          ...
          function (e) {
            ...
            if (
              ...
              (de.leadingWhitespace || !Re.test(e)) &&
              !Xe[($e.exec(e) || ["", ""])[1].toLowerCase()]
            ) {
    ...
    function t() {
      ...
      d.appendChild(l),
        ...
        e.getComputedStyle &&
          ...
          (t.style.cssText = u.style.cssText =
    ...
    style: function (e, t, n, i) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var r,
          ...
          l = e.style;
        if (
          ((t = pe.cssProps[s] || (pe.cssProps[s] = D(s) || s)),
        ...
        set: function (e, t) {
          ...
          (n.zoom = 1),
            ((t >= 1 || "" === t) &&
              ...
              (n.filter = vt.test(o) ? o.replace(vt, r) : o + " " + r);
        },
      }),
    ...
    pe.extend({
      valHooks: {
        ...
        select: {
          ...
          set: function (e, t) {
            for (
              var n, i, r = e.options, o = pe.makeArray(t), a = r.length;
              a--;

            )
              if (((i = r[a]), pe.inArray(pe.valHooks.option.get(i), o) > -1))
                try {
                  i.selected = n = !0;
                } catch (e) {
                  i.scrollHeight;
        ...
        if (3 !== o && 8 !== o && 2 !== o)
          return "undefined" == typeof e.getAttribute
            ...
            : ((1 === o && pe.isXMLDoc(e)) ||
                ((t = t.toLowerCase()),
                (r =
                  pe.attrHooks[t] || (pe.expr.match.bool.test(t) ? Dt : _t))),
              void 0 !== n
                ? null === n
      ...
      set: function (e, t, n) {
        return (
          t === !1
            ? pe.removeAttr(e, n)
            : (Mt && Ot) || !Ht.test(n)
            ? e.setAttribute((!Ot && pe.propFix[n]) || n, n)
    ...
    toggleClass: function (e, t) {
      ...
      return "boolean" == typeof t && "string" === n
        ...
        : this.each(function () {
            var t, i, r, o;
            if ("string" === n)
              for (i = 0, r = pe(this), o = e.match(Ae) || []; (t = o[i++]); )
  ...
  (pe.parseJSON = function (t) {
    ...
    (pe.parseXML = function (t) {
      ...
      try {
        e.DOMParser
          ? ((i = new e.DOMParser()), (n = i.parseFromString(t, "text/xml")))
  ...
  pe.extend({
    ...
    ajax: function (t, n) {
          ...
          o
            ? (f.ifModified &&
              ...
              204 === t || "HEAD" === f.type
                ...
                : 304 === t
                ? (T = "notmodified")
                : ((T = b.state), (d = b.data), (y = b.error), (o = !y)))
      ...
      (u = pe.event && f.global),
        ...
        f.ifModified &&
          (pe.lastModified[a] &&
            C.setRequestHeader("If-Modified-Since", pe.lastModified[a]),
      ...
      if ((c = Y(Jt, f, n, C))) {
        if (((C.readyState = 1), u && h.trigger("ajaxSend", [C, f]), 2 === x))
          return C;
        f.async &&
          f.timeout > 0 &&
  ...
  pe.ajaxSetup({
    ...
    pe.ajaxPrefilter("json jsonp", function (t, n, i) {
      ...
      return s || "jsonp" === t.dataTypes[0]
        ? ((r = t.jsonpCallback = pe.isFunction(t.jsonpCallback)
            ? t.jsonpCallback()
            : t.jsonpCallback),
          s
            ? (t[s] = t[s].replace(fn, "$1" + r))
            : t.jsonp !== !1 &&
              (t.url += (zt.test(t.url) ? "&" : "?") + t.jsonp + "=" + r),
  ...
  (pe.fn.load = function (e, t, n) {
    ...
    pe.each({ Height: "height", Width: "width" }, function (e, t) {
      pe.each({ padding: "inner" + e, content: t, "": "outer" + e }, function (
        n,
        i
      ) {
              ...
              if (
                ...
                var r =
                    ...
                    (n.attr("height") && !isNaN(parseInt(n.attr("height"), 10)))
                      ...
                      : n.height(),
                  o = isNaN(parseInt(n.attr("width"), 10))
                    ? n.width()
...
$(window).resize(function () {
  ...
  (function (e) {
    var t,
      ...
      N = function () {
        e.magnificPopup.instance ||
          ((t = new x()), t.init(), (e.magnificPopup.instance = t));
      },
      L = function () {
    ...
    (x.prototype = {
      ...
      open: function (n) {
        ...
        E("BeforeOpen"),
          ...
          (t.st.fixedBgPos === !1 ||
            ...
            t.bgOverlay.css({ height: r.height(), position: "absolute" }),
          t.st.enableEscapeKey &&
            r.on("keyup" + g, function (e) {
      ...
      (e.fn.magnificPopup = function (n) {
        ...
        if ("string" == typeof n)
          if ("open" === n) {
            var r,
              o = w ? i.data("magnificPopup") : i[0].magnificPopup,
    ...
    var A,
      ...
      D = "inline",
      I = function () {
        _ && (j.after(_.addClass(A)).detach(), (_ = null));
      };
        ...
        getInline: function (n, i) {
          if ((I(), n.src)) {
            ...
            if (o.length) {
              ...
              a &&
                a.tagName &&
                (j || ((A = r.hiddenClass), (j = k(A)), (A = "mfp-" + A)),
    ...
    e.magnificPopup.registerModule(O, {
      ...
      proto: {
        ...
        getAjax: function (n) {
          H && i.addClass(H), t.updateStatus("loading");
          var r = e.extend(
            {
              url: n.src,
      ...
      proto: {
        initImage: function () {
          ...
          t.types.push("image"),
            ...
            T(l + n, function () {
              e.cursor && i.removeClass(e.cursor), C.off("resize" + g);
            }),
        ...
        getImage: function (n, i) {
          ...
          return (
            t._parseMarkup(i, { title: F(n), img_replaceWith: n.img }, n),
            t.resizeImage(),
            n.hasSize
              ? (B && clearInterval(B),
                n.loadError
                ...
                (d = !1),
                  ...
                  C.on("touchmove" + o, function (e) {
                    (f = e.originalEvent ? e.originalEvent.touches : e.touches),
                      (p = f.length),
                      (f = f[0]),
                      (Math.abs(f.clientX - u) > 10 ||
                        Math.abs(f.clientY - c) > 10) &&
                        ((d = !0), i());
          ...
          this.each(function () {
            ...
            if (this !== document && this !== window)
              return !document.scrollingElement ||
                ...
                ? void (t[r]() > 0
                    ? n.push(this)
                    : (t[r](1), (i = t[r]() > 0), i && n.push(this), t[r](0)))
    ...
    e.fn.extend({
        ...
        var i = e.extend({}, e.fn.smoothScroll.defaults, t),
          r = function (t) {
            var n = function (e) {
              ...
              v = n(r.hash);
            if (
              (v && !e(v).length && (d = !1), a.scrollTarget || (m && g && v))
            ) {
            ...
            d &&
              ...
              e.extend(f, a, { scrollTarget: a.scrollTarget || v, link: r }),
              e.smoothScroll(f));
          };
        return (
          null !== t.delegateSelector
            ? this.undelegate(
                t.delegateSelector,
                "click.smoothscroll"
              ).delegate(t.delegateSelector, "click.smoothscroll", r)
            : this.unbind("click.smoothscroll").bind("click.smoothscroll", r),
          this
        );
      },
    }),
      (e.smoothScroll = function (t, i) {
        ...
        var r,
          ...
          p = {};
        "number" == typeof t
          ? ((r = e.extend({ link: null }, e.fn.smoothScroll.defaults, n)),
            (a = t))
          : ((r = e.extend(
              { link: null },
          ...
          r.scrollElement
            ? ((o = r.scrollElement),
              /^(?:HTML|BODY)$/.test(o[0].nodeName) || (u = o[d]()))
          ...
          (a =
            "number" == typeof t
              ...
              : i ||
                (e(r.scrollTarget)[c]() &&
                  e(r.scrollTarget)[c]()[r.direction]) ||
                0),
          (f[d] = a + u + r.offset),
          (s = r.speed),
          "auto" === s &&
            ((l = Math.abs(f[d] - o[d]())), (s = l / r.autoCoefficient)),
          (p = {
            duration: s,
            easing: r.easing,
            complete: function () {
  ...
  !(function (e, t) {
    ...
    function o() {
      _ = { top: t.pageYOffset, left: t.pageXOffset };
    }
    function a() {
      return t.pageXOffset != _.left
        ? (o(), void E())
        : void (t.pageYOffset != _.top && (o(), l()));
    }
    function s(e) {
      setTimeout(function () {
        t.pageYOffset != _.top && ((_.top = t.pageYOffset), l());
      }, 0);
    }
    function l() {
      for (var e = I.length - 1; e >= 0; e--) u(I[e]);
    }
    function u(e) {
      if (e.inited) {
    ...
    function d(e) {
      isNaN(parseFloat(e.computed.top)) ||
        ...
        ((e.inited = !0),
        e.clone || g(e),
        "absolute" != e.parent.computed.position &&
          "relative" != e.parent.computed.position &&
          (e.parent.node.style.position = "relative"),
        u(e),
    ...
    function p() {
      for (var e = I.length - 1; e >= 0; e--) d(I[e]);
    }
    function h() {
      for (var e = I.length - 1; e >= 0; e--) f(I[e]);
    }
    function m(e, t) {
      var n = e.node.style;
      switch (t) {
    ...
    function y(e) {
      ...
      var l = {
        ...
        f = {
          node: e,
          box: { left: u.win.left, right: O.clientWidth - u.win.right },
          offset: {
    ...
    function x(e) {
      ...
      return {
        doc: { top: n.top + t.pageYOffset, left: n.left + t.pageXOffset },
        win: n,
      };
    }
    function w() {
    ...
    function E() {
      if (H) {
        h();
        for (var e = I.length - 1; e >= 0; e--) I[e] = y(I[e].node);
        p();
      }
    }
    function S() {
    ...
    function L() {
      for (N(); I.length; ) I.pop();
    }
    function A(e) {
      for (var t = I.length - 1; t >= 0; t--) if (I[t].node === e) return;
      var n = y(e);
      I.push(n), H ? d(n) : k();
    }
    function j(e) {
      for (var t = I.length - 1; t >= 0; t--)
        I[t].node === e && (f(I[t]), I.splice(t, 1));
    }
    var _,
      D,
      I = [],
    ...
    void 0 !== e.webkitHidden &&
      ((P = "webkitHidden"), (B = "webkitvisibilitychange")),
  ...
  $(document).ready(function () {
    ...
    var e = function () {
      ...
      e
        ? (Stickyfill.rebuild(), Stickyfill.init(), $(".author__urls").show())
