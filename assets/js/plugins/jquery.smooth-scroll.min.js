  ...
  a.fn.extend({
    ...
    smoothScroll: function (b, c) {
      ...
      return (
        null !== b.delegateSelector
          ? this.undelegate(b.delegateSelector, "click.smoothscroll").delegate(
              b.delegateSelector,
              "click.smoothscroll",
              e
            )
          : this.unbind("click.smoothscroll").bind("click.smoothscroll", e),
        this
      );
    },
  }),
    (a.smoothScroll = function (b, d) {
      ...
      var e,
        ...
        n = {};
      "number" == typeof b
        ? ((e = a.extend({ link: null }, a.fn.smoothScroll.defaults, c)),
          (g = b))
        : ((e = a.extend(
            { link: null },
